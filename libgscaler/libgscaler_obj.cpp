    ...
    int v4l2_colorformat)
{
    ...
    case V4L2_PIX_FMT_NV21M:
        *w = (*w + 15) & ~15;
        *h = (*h + 15) & ~15;
        *crop_w = CGscaler::m_gsc_multiple_of_n(*crop_w, 2);
        *crop_h = CGscaler::m_gsc_multiple_of_n(*crop_h, 2);
        break;
    // YUV422
    ...
    case V4L2_PIX_FMT_VYUY:
        *h = (*h + 7) & ~7;
        *crop_w = CGscaler::m_gsc_multiple_of_n(*crop_w, 4);
        *crop_h = CGscaler::m_gsc_multiple_of_n(*crop_h, 2);
        break;
    // RGB
    ...
    int rotation)
{
    ...
    case V4L2_PIX_FMT_YVU420M:
    case V4L2_PIX_FMT_YVU420:
        *new_w = CGscaler::m_gsc_multiple_of_n(*new_w, 2);
        *new_h = CGscaler::m_gsc_multiple_of_n(*new_h, 2);
        break;
    // YUV422
    case V4L2_PIX_FMT_YUYV:
    case V4L2_PIX_FMT_YUV422P:
    ...
    exynos_gsc_img *src_img, exynos_gsc_img *dst_img)
{
    ...
    memcpy(&gsc->src_img, src_img, sizeof(exynos_gsc_img));
    memcpy(&gsc->dst_img, dst_img, sizeof(exynos_gsc_img));
    src_color_space = HAL_PIXEL_FORMAT_2_V4L2_PIX(src_img->format);
    dst_color_space = HAL_PIXEL_FORMAT_2_V4L2_PIX(dst_img->format);
...
int CGscaler::m_gsc_out_run(void *handle, exynos_gsc_img *src_img)
{
